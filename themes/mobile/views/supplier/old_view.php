                ...
                <div class="info">
                    ...
                    <ul>
                        <li>Минимальная сумма доставки<br/>
                            ...
                            <p class="price"><?php echo $partner->min_sum ? $partner->min_sum . ' <?php echo City::getMoneyKod() ;?>' : 'Нет' ?></p>
                        </li>
                        <li>Стоимость достаки<br/>

                            <p class="price"><?php echo $partner->delivery_cost ? $partner->delivery_cost . ' <?php echo City::getMoneyKod() ;?>' : 'Бесплатно' ?></p>
                        </li>
                                ...
                                <form>
                                    <p class="product_counter_container"
                                       id="product_<?php echo $goods->id ?>_counter_container">
                                        <b><?php echo $goods->price; ?></b> <?php echo City::getMoneyKod(); ?> <a
                                            class="showed_product_counter" href="javascript:void(0);"><span
