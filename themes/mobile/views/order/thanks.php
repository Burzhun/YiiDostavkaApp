<div class="page">
    <div class="blok">
        <p class="crumbs">
            <a href="">главная</a> / <a class="crumbs_a" href="">о нас</a>
        </p>
        <div class="page_basket">
            <div class="basket_home">
                <div class="thank_you"><p>Спасибо за заказ!</p></div>
                <? if ($user_registrated) { ?>
                    <p class="thank_you">Спасибо за регистрацию! Для завершения регистрации пройдите по ссылке
                        оправленной на ваш почтовый адрес.</p>
                <? } ?>
