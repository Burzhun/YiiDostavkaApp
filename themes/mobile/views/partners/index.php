                    ...
                    <div class="order_left">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td><?php echo $form->dropDownList($partnerreg, 'city_id', CHtml::listData(City::model()->findAll(), 'id', 'name'), array('style' => 'width:273px')); ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><?php echo $form->textField($partnerreg, 'work_begin_time', array('class' => 'txt', 'size' => 10, 'maxlength' => 10, 'placeholder' => 'Начало - чч:мм', 'value' => '09:00', 'style' => 'width:100px;float:left;margin-right:5px')); ?><?php echo $form->textField($partnerreg, 'work_end_time', array('class' => 'txt', 'size' => 2, 'maxlength' => 10, 'placeholder' => 'Конец - чч:мм', 'value' => '18:00', 'style' => 'width:100px;float:left')); ?></td>
                                <td></td>
                            </tr>
                            <tr>
                                ...
                                <?php foreach ($direction as $d) { ?>
                                    <td>
                                        <div>
                                            <b><?php echo $d->name; ?></b>
                                            <br><br>
                                            <?php foreach (Specialization::model()->findAll(array('condition' => 'direction_id=' . $d->id." and domain_id=".$this->domain->id, 'order' => 'pos')) as $s) { ?>
