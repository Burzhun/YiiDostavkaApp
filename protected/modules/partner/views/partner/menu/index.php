...
<div class="well">
    ...
    <? $menu_search = $menu->search(array('parent_id' => '0', 'partner_id' => $model->id));
    $this->widget('zii.widgets.grid.CGridView', array(
        'id' => 'menu-grid',
        'dataProvider' => $menu_search,
        'filter' => $menu,
        'emptyText' => 'Меню пусто. Для начала добавьте категорию товаров. Например: шашлыки, напитки, закуски',
        'summaryText' => '',
