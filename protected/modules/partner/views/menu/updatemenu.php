...
<br>
    <?php// if ($menu_model->parent_id != 0) { ?>
        ...
        <?php echo $form->dropDownList($menu_model, 'parent_id', ['Главное меню']+CHtml::listData(Menu::model()->findAll(array('condition' => 'parent_id=0')), 'id', 'name')); ?>
        ...
        $("#user-form").submit(function(){
            ...
            if(t==0){
                ...
                if(last==t){
                    ...
                    $.get('/partner/menu/checkmenu/' +t,{},function(data){
                        if(data==1){
                            submit_form=true;
                            last=t;
                            $("#user-form").submit();
