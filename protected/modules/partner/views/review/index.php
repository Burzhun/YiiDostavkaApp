...
<?php $this->renderPartial('../layouts/header', array('model' => $partner, 'breadcrumbs' => $breadcrumbs, 'h1' => $this->H1)) ?>
<!-- <div class="h1-box">
...
Yii::app()->clientScript->registerScript('published', '
	$("#published").live("click",function () {
		...
		$.getJSON("/partner/review/togglepub?id="+id,function(data){
			if(data.error)
				alert(data.msg);
			else{
					if(data.pub){
...
<div class="well well-bottom">
    <?php $this->widget('zii.widgets.grid.CGridView', array(
        'id' => 'review-grid',
        'dataProvider' => $model->search($partner->id),
        'filter' => $model,
