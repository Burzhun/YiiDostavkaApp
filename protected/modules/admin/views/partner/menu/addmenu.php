...
<div class="well">
    ...
    <div>
        ...
        <?php echo $form->hiddenField($menu_model, 'parent_id', array('value' => $_GET['actionId'])); ?>
        <?php echo $form->hiddenField($menu_model, 'pos', array('value' => '0')); ?>
        <?php echo $form->hiddenField($menu_model, 'partner_id', array('value' => $_GET['id'])); ?>
