...
<?php $this->renderPartial('header', array('model' => $modelPartner, 'breadcrumbs' => $breadcrumbs, 'h1' => $h1)) ?>
<!-- <div class="h1-box">
...
Yii::app()->clientScript->registerScript('published', '
	$("#published").live("click",function () {
		...
		$.getJSON("/admin/partner/togglepub?id="+id,function(data){
			if(data.error)
				alert(data.msg);
			else{
					if(data.pub){
...
<div class="well well-bottom">
    <?php $this->widget('zii.widgets.grid.CGridView', array(
        'id' => 'review-grid',
        'dataProvider' => $model->search($modelPartner->id),
        'filter' => $model,
