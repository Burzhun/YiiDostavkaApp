...
<div class="well">
    ...
    <?php echo $form->textArea($goods_model, 'text', array('class' => 'txt','style'=>'width:300px','rows'=>6, 'size' => 160, 'maxlength' => 255)); ?>
    <?php echo $form->error($goods_model, 'text'); ?>

    <?php echo $form->labelEx($goods_model, 'tag_id'); ?>
    <?php echo $form->dropDownList($goods_model, 'tag_id', array('0' => 'Не выбран') + Tag::getTagList()); ?>
    <?php echo $form->error($goods_model, 'tag_id'); ?>
