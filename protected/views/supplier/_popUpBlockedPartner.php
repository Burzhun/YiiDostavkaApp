<div id="pop-up-bascet">
    <div class="pop-header">
        <h3>
            <img src="/upload/partner/<?= $partner->img; ?>" style="width: 60px;margin-top: -23px;margin-right: 20px;">
            "<?= $partner->name ?>" временно заблокированно
        </h3>
    </div>
    ...
    <div>
        <p class="blocked-partner-msg-title">
            Рекомендуем обратить внимание на другие рестораны готовые принять ваш заказ.
        </p>
